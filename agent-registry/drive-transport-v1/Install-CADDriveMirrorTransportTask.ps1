[CmdletBinding()]
param(
    [string]$TaskName = 'CADGrounded Drive Mirror Transport ReadOnly',
    [string]$TransportPath = (Join-Path $PSScriptRoot 'Invoke-CADDriveMirrorTransport.ps1'),
...
Register-ScheduledTask `
    ...
    -Settings $settings `
    -Principal $principal `
    -Description 'CADGrounded Drive Desktop mirror JSON handoff only. No CAD write authority.' `
    -Force | Out-Null
