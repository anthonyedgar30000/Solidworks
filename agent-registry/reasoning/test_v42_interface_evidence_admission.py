...
from v42_interface_evidence_admission import (CURRENT, STALE, UNRESOLVED, CURRENT_CLAIMS, UNRESOLVED_CLAIMS, admit_host_artifact, build_dependency_graph, supersede_evidence, validate_evidence_record)
...
class V42InterfaceEvidenceAdmissionTests(unittest.TestCase):
    def setUp(self):
        self.record = admit_host_artifact(json.loads(ARTIFACT.read_text(encoding="utf-8")))
